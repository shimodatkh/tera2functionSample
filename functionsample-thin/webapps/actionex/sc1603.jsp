...
<bean:define id="titleScreenName" scope="page" value="アクション拡張トークンチェックエラー"/>
<bean:define id="screenName" scope="page" value="アクション拡張トークンチェックエラー"/>
...
<!-- begin body-->
  <h4>トランザクショントークンチェックエラー</h4>
  <table border="0" style="width:100%;">
    <tr>
      <td align="center">
        <h1>
          <font color="red"><strong>
            !!&nbsp;トランザクショントークンエラーが発生しました。&nbsp;!!
          </strong></font>
        </h1>
      </td>
    </tr>
