<%--
  - $Id: sc1402.jsp,v 1.12 2006/02/08 02:39:12 jeon Exp $
  -
...
<bean:define id="screenID" scope="page" value="SC1402"/>

<%
  jp.terasoluna.fw.exception.SystemException exception = 
  (jp.terasoluna.fw.exception.SystemException) request.getAttribute(PageContext.EXCEPTION);
%>
