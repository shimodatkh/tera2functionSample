<%--
  - $Id: sc1104.jsp,v 1.12 2006/02/08 02:39:12 jeon Exp $
  -
...
<bean:define id="titleScreenName" scope="page" value="切り替え：フォーム（clearForm=false）"/>
<bean:define id="screenName" scope="page" value="切り替え：フォーム（clearForm=false）"/>
<bean:define id="screenID" scope="page" value="SC1104"/>
<%-- アクションフォーム --%>
...
<br>
<html:link href="formtransFormResultForward.do">フォーム切り替え：フォーム</html:link>
<br><br>
<!-- end body-->
