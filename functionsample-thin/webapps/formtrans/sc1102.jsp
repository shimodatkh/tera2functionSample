<%--
  - $Id: sc1102.jsp,v 1.12 2006/02/08 02:39:12 jeon Exp $
  -
...
<bean:define id="titleScreenName" scope="page" value="フォーム切り替えなし（clearForm=false）"/>
<bean:define id="screenName" scope="page" value="フォーム切り替えなし（clearForm=false）"/>
<bean:define id="screenID" scope="page" value="SC1102"/>
...
<br>
<html:link href="formtransResultForward.do">フォーム切り替えなし（clearForm="false"）</html:link>
<br><br>
<!-- end body-->
