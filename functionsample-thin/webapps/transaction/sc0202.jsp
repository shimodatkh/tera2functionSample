...
<bean:define id="titleScreenName" scope="page" value="一般DBアクセスのトランザクション処理"/>
<bean:define id="screenName" scope="page" value="一般DBアクセスのトランザクション処理"/>
  ...
  <ts:form action="generalInsertAddress.do" onsubmit="return true;">
    <table border="1">
      ...
      <tr>
        ...
        <td>
          <html:text property="customerName1" maxlength="30" tabindex="2" size="40" value="田中"/>
        </td>
      </tr>
      <tr>
    ...
    <table border="1">
      ...
      <tr>
        <td width="80" align="center"><b>顧客氏名</b></td>
        <td>
          <html:text property="customerName2" maxlength="30" tabindex="7" size="40" value="木村"/>
        </td>
      </tr>
      <tr>
        <td width="80" align="center"><b>郵便番号</b></td>
