<%--
  - $Id: sc2017.jsp,v 1.12 2006/02/08 02:39:12 jeon Exp $
  -
...
<bean:define id="screenName" scope="page" value="静的アクションフォームでpageを業務パラメータとして利用する(検証成功画面)" />
<bean:define id="screenID" scope="page" value="SC2017" />
...
<ts:form styleId="form" action="/mpvActionAcceptPageNoneWithPageImpl.do">
    <table border="1">
        <tr>
            ...
            <td style="text-align: left; width: 40px;"><span id="code1"><bean:write name="_multiPageValidationFormWithPageImpl"
        ...
        <tr>
            ...
            <td style="text-align: left; width: 40px;"><span id="pageTextBox"><bean:write name="_multiPageValidationFormWithPageImpl"
