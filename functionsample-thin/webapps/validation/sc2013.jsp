<%--
  - $Id: sc2013.jsp,v 1.12 2006/02/08 02:39:12 jeon Exp $
  -
...
<bean:define id="screenName" scope="page" value="動的アクションフォームでpageをMPV機能として利用する(1/3ページ)" />
<bean:define id="screenID" scope="page" value="SC2013" />
