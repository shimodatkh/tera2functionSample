<%--
  - $Id: sc2011.jsp,v 1.12 2006/02/08 02:39:12 jeon Exp $
  -
...
<bean:define id="screenName" scope="page" value="静的アクションフォームでpageをMPV機能として利用する(2/3ページ)" />
<bean:define id="screenID" scope="page" value="SC2011" />
...
<ts:form styleId="form" action="/mpvActionAcceptPage0Dispatch.do">
    <table border="1">
        <tr>
            <td>項目１</td>
    ...
    <br>
    <div>
        <html:submit property="forward_back" value="前へ" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
