...
package jp.terasoluna.thin.functionsample.messageex6.web.action;
...
public class SpringMessageResourceAction 
    ...
    public BLogicResult doExecuteBLogic(Object param) 
        ...
        msg.add("1", new BLogicMessage("info.UC21.00035"));
        msg.add("2", new BLogicMessage("info.UC21.00036"));
        msg.add("3", new BLogicMessage("info.UC21.00037"));
        msg.add("4", new BLogicMessage("info.UC21.00038"));
