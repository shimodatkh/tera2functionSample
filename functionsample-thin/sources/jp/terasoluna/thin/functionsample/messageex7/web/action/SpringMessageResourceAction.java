...
package jp.terasoluna.thin.functionsample.messageex7.web.action;
...
public class SpringMessageResourceAction
    ...
    public BLogicResult doExecuteBLogic(Object param)
        ...
        msg.add("1", new BLogicMessage("info.UC21.00039"));
        msg.add("2", new BLogicMessage("info.UC21.00040"));
        msg.add("3", new BLogicMessage("info.UC21.00041"));
        msg.add("4", new BLogicMessage("info.UC21.00042"));
