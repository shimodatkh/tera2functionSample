...
package jp.terasoluna.thin.functionsample.date.web.form;

import jp.terasoluna.fw.web.struts.form.ValidatorActionFormEx;

/**
 * date機能で使われるActionForm
 * 
 */
public class DateForm extends ValidatorActionFormEx {

    /**
     * シリアルバージョンID
     */
    private static final long serialVersionUID = 1338847798328834394L;

    /**
     * 出力対象日付（パターン4）。
     */
    private String datePattern04 = "2009/03/21 12:34:56";
    ...
    /**
     * @param datePattern10 設定する datePattern10
     */
