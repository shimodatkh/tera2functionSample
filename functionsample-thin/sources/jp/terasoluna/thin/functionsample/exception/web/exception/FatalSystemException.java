...
public class FatalSystemException extends SystemException {
     ...
     * serialVersionUID.
     */
    private static final long serialVersionUID = 1880073168045642939L;

    public FatalSystemException(Throwable cause) {
        super(cause);
    }

    public FatalSystemException(Throwable cause, String errorCode) {
    ...
    public FatalSystemException(Throwable cause, String errorCode, String s0) {
