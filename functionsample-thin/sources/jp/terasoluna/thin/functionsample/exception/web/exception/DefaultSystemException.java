...
public class DefaultSystemException extends SystemException {
     ...
     * serialVersionUID.
     */
    private static final long serialVersionUID = 2896146558310430471L;

    public DefaultSystemException(Throwable cause) {
        super(cause);
    }

    public DefaultSystemException(Throwable cause, String errorCode) {
    ...
    public DefaultSystemException(Throwable cause, String errorCode, String s0) {
