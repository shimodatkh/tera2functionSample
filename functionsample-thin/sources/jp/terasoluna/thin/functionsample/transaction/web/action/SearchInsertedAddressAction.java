...
import jp.terasoluna.thin.functionsample.transaction.service.SelectAddressService;
 ...
 *
 */
public class SearchInsertedAddressAction extends
    ...
    public BLogicResult doExecuteBLogic(InsertAddressParam param) 
        ...
        //登録されたデータ取得処理
        AddressVO[] searchResult = new AddressVO[2];
