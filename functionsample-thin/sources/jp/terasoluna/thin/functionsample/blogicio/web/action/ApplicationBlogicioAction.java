...
/**
 * Blogicio処理でアプリケーションスコープを利用した場合のアクションクラス
 */
public class ApplicationBlogicioAction
        extends AbstractBLogicAction<BlogicioParam> {

    /**
     * ログクラス。
     */
    private static Log log = LogFactory.getLog(ApplicationBlogicioAction.class);
    ...
    public BLogicResult doExecuteBLogic(BlogicioParam param) throws Exception {
        ...
        map.put("application", "アクションで変更されたアプリケーションデータ");
