...
/**
 * Blogicio処理でリクエストスコープを利用した場合のアクションクラス
 */
public class RequestBlogicioAction extends
        AbstractBLogicAction<BlogicioParam> {

    /**
     * ログクラス。
     */
    private static Log log = LogFactory.getLog(RequestBlogicioAction.class);
    
    /**
     * Blogicio処理でリクエストを利用した場合
     * 
     * @param param リクエストから取得したデータ
     * @return 結果データ
    ...
    public BLogicResult doExecuteBLogic(BlogicioParam param) throws Exception {
        ...
        map.put("request", "アクションで変更されたリクエストデータ");
        // BLogicParam内容
