...
package jp.terasoluna.thin.functionsample.messageex8.web.action;
...
public class SpringMessageResourceAction
    ...
    public BLogicResult doExecuteBLogic(Object param)
        ...
        msg.add("1", new BLogicMessage("info.UC21.00043"));
        msg.add("2", new BLogicMessage("info.UC21.00044"));
        msg.add("3", new BLogicMessage("info.UC21.00045"));
        msg.add("4", new BLogicMessage("info.UC21.00046"));
