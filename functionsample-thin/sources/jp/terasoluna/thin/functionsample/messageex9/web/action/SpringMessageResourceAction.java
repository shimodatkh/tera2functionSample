...
package jp.terasoluna.thin.functionsample.messageex9.web.action;
...
public class SpringMessageResourceAction
    ...
    public BLogicResult doExecuteBLogic(Object param)
        ...
        msg.add("1", new BLogicMessage("info.UC21.00047"));
        msg.add("2", new BLogicMessage("info.UC21.00048"));
        msg.add("3", new BLogicMessage("info.UC21.00049"));
        msg.add("4", new BLogicMessage("info.UC21.00050"));
